...
model10y1<-lm(cnt~actualtemp+weatherfac+windspeed+seasonfac, data=bikerentalyear1)
summary(model10y1)
...
library(car)
vif(model10y1a)
plot(bikerentalyear1$season)


bikerental12<-bikerental1$season
bikerental12

cbind(bikerental12,bikerental1$yr)
